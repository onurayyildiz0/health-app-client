...
const authSlice = createSlice({
    ...
    reducers: {
        ...
        registerSuccess: (state) => {
            ...
            // NOT: Backend'den token gelmediği için (email onayı şartı)
            // burada kullanıcıyı login yapmıyoruz ve localStorage'a yazmıyoruz.
            // Sadece loading durumunu kapatıyoruz.
        },
